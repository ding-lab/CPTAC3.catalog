...
Files `discover.20191107.AR.dat` and `discover.20191107.Demographics.dat` are draft releases of `v2.0` release of CPTAC3 discovery.
...
Goal is to review changes prior to general release

### Details

AR and Demographics files generated by [CPTAC3.case.discover](https://github.com/ding-lab/CPTAC3.case.discover)
commit `c09e44f5`, run on `Sat Nov 9 09:30:29 CST 2019`
