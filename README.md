...
* `CPTAC3.Demographics.dat`: Demographic information associated with all known cases
    * Generated by (CPATC3 Case Discover](https://github.com/ding-lab/CPTAC3.case.discover)
...
Array data available at GDC.  Generated by (CPATC3 Case
Discover](https://github.com/ding-lab/CPTAC3.case.discover). 
